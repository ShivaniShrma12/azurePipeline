...
exports.server = apiUrls_1.urls.server;
...
const convertJSONtoXAML = (jsonData) => __awaiter(void 0, void 0, void 0, function* () {
    const url = exports.server + apiUrls_1.endpoints.xaml;
...
const retrieveAndDownload = (events) => {
    ...
    chrome.storage.local.get(['jsonObject'], (result) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (data) {
            ...
            yield (0, downloadHelper_1.postExecutionDetail)('Tx_' + fileName, exports.server + apiUrls_1.endpoints.execution);
        }

...
public class KeywordUtil extends GlobalUtil {
	...
	private static final Duration DEFAULT_WAIT_SECONDS = Duration.ofSeconds(60);
...
//			wait.ignoring(ElementNotVisibleException.class);
	 ...
	 * @return
	 */
	public static WebElement waitForVisible(By locator,String logStep) {
		WebElement element = null;
		try {
			WebDriverWait wait = new WebDriverWait(getDriver(), DEFAULT_WAIT_SECONDS);
...
//			wait.ignoring(ElementNotVisibleException.class);
	 ...
	 * @return
	 */
	public static boolean clearInput(By locator,String logstep) {
		Boolean flag = false;
		WebElement element;
		try {
			element = waitForVisible(locator);
	...
	public static void catchAssertError(Throwable e) {
		String[] msg = e.getMessage().split("Build");
